   ...
   public class PaqueteriaServices
    {
        ...
        public IEnumerable<WV_tblPaquetes_Libres> ListarPaquetesLibres()
        {
            var result = new ServiceResult();
            var list = _paquetesRepository.Listaaa();
            return list;
        }
        ...
        public  IEnumerable<tblEnviosPorPaquetes> ListarPaquetesPorEnvio (tblEnviosPorPaquetes item)
        {
